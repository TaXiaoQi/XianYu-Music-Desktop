  ...
  <div class="flex min-h-full min-w-0 flex-col items-center pb-8">
    ...
    <div class="flex max-w-full flex-nowrap items-center justify-center gap-2">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        class="flex shrink-0 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-xl bg-white/20 backdrop-blur-md border border-gray-200/40 px-3.5 py-2 text-xs font-medium text-gray-800 no-underline transition active:scale-95 shadow-sm hover:bg-white/30 hover:border-[#EC4141]/35 dark:bg-black/10 dark:border-gray-800/40 dark:text-white dark:hover:bg-white/10"
      >
