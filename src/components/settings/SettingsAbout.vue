...
<template>
  <div class="flex min-h-full min-w-0 flex-col items-center px-4 pb-[clamp(16px,3vh,32px)] animate-in fade-in slide-in-from-bottom-2 duration-300">
    <div class="flex w-full flex-1 flex-col items-center justify-center gap-[clamp(12px,2.5vh,28px)] py-[clamp(8px,2vh,20px)]">
      ...
      <div class="flex items-center justify-center">
        <img
          src="/logo.png"
          alt="Logo"
          class="h-[clamp(64px,15vh,140px)] w-[clamp(64px,15vh,140px)] object-contain dark:invert"
        />
      </div>

      <div class="space-y-1">
        <h1 class="text-[clamp(18px,3vh,28px)] font-bold tracking-tight text-gray-800 dark:text-white">弦予音乐</h1>
        <p class="text-[clamp(11px,1.5vh,14px)] font-medium text-gray-600 dark:text-white/60">v{{ appVersion }}</p>
      </div>

      <p class="max-w-sm text-[clamp(12px,1.6vh,15px)] text-gray-600 dark:text-gray-300">
        将音乐给予你
      </p>
    </div>

    <div class="flex max-w-full flex-wrap items-center justify-center gap-[clamp(4px,0.8vw,10px)]">
      <button
        type="button"
        :disabled="isCheckingUpdate"
        @click="handleCheckUpdate"
        class="flex shrink-0 items-center gap-[clamp(2px,0.4vw,6px)] whitespace-nowrap rounded-xl bg-[#EC4141] px-[clamp(8px,1.2vw,16px)] py-[clamp(5px,0.7vh,10px)] text-[clamp(10px,1.3vh,13px)] font-medium text-white shadow-lg shadow-red-500/20 transition active:scale-95 hover:bg-[#d13a3a] disabled:cursor-not-allowed disabled:opacity-70"
      >
        <svg v-if="isCheckingUpdate" class="h-[clamp(12px,1.6vh,16px)] w-[clamp(12px,1.6vh,16px)] shrink-0 animate-spin" viewBox="0 0 24 24" fill="none">
          <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
          <path class="opacity-90" fill="currentColor" d="M4 12a8 8 0 0 1 8-8v4a4 4 0 0 0-4 4H4Z" />
        </svg>
        <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-[clamp(12px,1.6vh,16px)] w-[clamp(12px,1.6vh,16px)] shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm1-11a1 1 0 1 0-2 0v2H7a1 1 0 1 0 0 2h2v2a1 1 0 1 0 2 0v-2h2a1 1 0 1 0 0-2h-2V7Z" clip-rule="evenodd" /></svg>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        class="flex shrink-0 cursor-pointer items-center gap-[clamp(2px,0.4vw,6px)] whitespace-nowrap rounded-xl bg-[#EC4141] px-[clamp(8px,1.2vw,16px)] py-[clamp(5px,0.7vh,10px)] text-[clamp(10px,1.3vh,13px)] font-medium text-white no-underline shadow-lg shadow-red-500/20 transition active:scale-95 hover:bg-[#d13a3a]"
      >
        <svg xmlns="http://www.w3.org/2000/svg" class="h-[clamp(12px,1.6vh,16px)] w-[clamp(12px,1.6vh,16px)] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="mt-auto max-w-full shrink-0 space-y-1.5 pt-[clamp(10px,2vh,20px)] text-center text-[clamp(9px,1.2vh,12px)] leading-relaxed text-gray-400 dark:text-gray-600">
