  ...
  <div class="flex min-h-full min-w-0 flex-col items-center pb-8">
    ...
    <div class="flex max-w-full flex-col items-center gap-2.5">
      ...
      <button
        ...
        class="btn-liquid btn-liquid-primary flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-xl px-4 py-2 text-sm font-medium text-white disabled:cursor-not-allowed disabled:opacity-70"
      >
      ...
      <button
        ...
        class="btn-liquid btn-liquid-primary flex shrink-0 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-xl px-4 py-2 text-sm font-medium text-white no-underline"
      >
      ...
      <button
        ...
        class="btn-liquid flex shrink-0 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-xl px-4 py-2 text-sm font-medium text-gray-800 dark:text-white no-underline"
      >
