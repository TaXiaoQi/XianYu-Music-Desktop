...
<template>
  <Teleport to="body">
    <Transition name="app-backup-result">
      ...
      >
        <div class="flex max-h-[86vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-black/10 bg-white shadow-2xl dark:border-white/10 dark:bg-[#202023]">
