  ...
  >
    ...
    <div class="h-[44px] w-full flex items-center justify-center gap-5 px-6 pointer-events-auto">
      ...
      <button
        ...
        :class="isFavorite ? 'text-[color:var(--favorite-color)]' : 'text-white/80 hover:text-white hover:bg-white/10'"
