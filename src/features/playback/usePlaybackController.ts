...
export function usePlaybackController() {
  ...
  return {
    ...
    playbackSpeed: playbackRefs.playbackSpeed,
    ...
    handlePlaybackSpeed: playbackDomain.handlePlaybackSpeed,
    handlePlaybackSpeedWheel: playbackDomain.handlePlaybackSpeedWheel,
    resetPlaybackSpeed: playbackDomain.resetPlaybackSpeed,
