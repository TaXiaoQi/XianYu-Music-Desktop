...
const zhCN = {
  ...
  'pluginHost.availablePlugins': '可用插件',
  'pluginHost.scanDirsDesc': '扫描标准目录：用户级与系统级 VST3 / CLAP 文件夹。',
  'pluginHost.scanning': '扫描中...',
  'pluginHost.rescan': '重新扫描',
  'pluginHost.scanningDirs': '正在扫描标准插件目录...',
  'pluginHost.noPluginsFoundA': '未发现 VST3 / CLAP 插件。',
  'pluginHost.noPluginsFoundB': '将插件安装到 %LOCALAPPDATA%\\Programs\\Common\\VST3 或 Common\\CLAP 后重新扫描。',
  'pluginHost.alreadyInRack': '已在机架',
  'pluginHost.add': '添加',
  'pluginHost.open': '打开',
  'pluginHost.openLibraryHint': '{count} 个可用插件 — 点击「打开」在弹窗中查看与添加。',
  'pluginHost.rackChain': '机架链路',
  'pluginHost.slotCount': '{count} 个槽位',
  'pluginHost.emptyRack': '机架为空。从「可用插件」添加效果插件后，它们将按此顺序串联处理音频。',
...
const enUS: Record<I18nKey, string> = {
  ...
  'pluginHost.availablePlugins': 'Available plugins',
  'pluginHost.scanDirsDesc': 'Scans standard directories: user and system VST3 / CLAP folders.',
  'pluginHost.scanning': 'Scanning...',
  'pluginHost.rescan': 'Rescan',
  'pluginHost.scanningDirs': 'Scanning standard plugin directories...',
  'pluginHost.noPluginsFoundA': 'No VST3 / CLAP plugins found.',
  'pluginHost.noPluginsFoundB': 'Install plugins into %LOCALAPPDATA%\\Programs\\Common\\VST3 or Common\\CLAP and rescan.',
  'pluginHost.alreadyInRack': 'In rack',
  'pluginHost.add': 'Add',
  'pluginHost.open': 'Open',
  'pluginHost.openLibraryHint': '{count} available plugins — click "Open" to view and add in the popup.',
  'pluginHost.rackChain': 'Rack chain',
  'pluginHost.slotCount': '{count} slots',
  'pluginHost.emptyRack': 'The rack is empty. Add effect plugins from "Available plugins" and they will process audio in chain order.',
